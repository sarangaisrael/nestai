...
const Dashboard = () => {
  ...
  const { daysLeft, isExpired, plan }   = useSubscription();
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#fafafa', fontFamily: "'Heebo', sans-serif" }} dir={dir}>
      ...
      <div className="dash-body">
        ...
        {/* ── Trial banner (≤7 days left on trial) ── */}
        {plan === "trial" && daysLeft <= 7 && !isExpired && (
          <div style={{
            marginTop: 12,
            background: '#fffbeb',
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, flex: 1, minWidth: 0 }}>
              ...
              <p style={{ margin: 0, fontSize: 13, fontWeight: 600, color: '#92400e', lineHeight: 1.3 }}>
                {daysLeft === 0
                  ? 'תקופת הניסיון שלך מסתיימת היום'
                  : `נותרו ${daysLeft} ימים בתקופת הניסיון`}
              </p>
            </div>
            <a
              href="https://wa.me/9720537000277?text=היי, אני רוצה לשדרג את המנוי שלי"
              target="_blank"
