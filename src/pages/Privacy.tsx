      ...
      <div className="container max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="space-y-6 text-foreground/90 leading-relaxed">
          ...
          <section>
            ...
            <p className="text-sm">
              כתובת אימייל (לצורך התחברות בלבד), רשומות יומן אישיות כולל תאריך ושעה, נתוני מצב רוח ופעילות יומיים, נתוני שינה, תוכן השיחות עם הבינה המלאכותית, וסיכומים שבועיים שנוצרו אוטומטית, וכן העדפות אישיות (יום ושעה לסיכום שבועי). איננו אוספים שם מלא, מספר טלפון, תעודת זהות, או כל מידע מזהה אחר מעבר לאימייל.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm">
              הנתונים מאוחסנים בשרתים באיחוד האירופי (פרנקפורט, גרמניה).
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm">
              תוכן גולמי — הודעות צ'אט ורשומות יומן מילוליות — נשמר 30 יום מיצירתו ולאחר מכן נמחק אוטומטית. סיכומים שבועיים ונתוני מצב רוח ושינה נשמרים לאורך זמן כדי לאפשר מעקב אחר מגמות והיסטוריה רגשית, גם לאחר מחיקת התוכן הגולמי. בעת מחיקת חשבון, כל הנתונים — כולל הסיכומים וההיסטוריה — נמחקים תוך 30 יום, וגיבויים טכניים תוך 90 יום.
            </p>
          </section>
