...
// nestai.care Premium price ID
const STRIPE_PRICE_ID = "price_1SkIVU3TviZudxRUPkzHzva5";
...
serve(async (req) => {
  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: "subscription",
      success_url: `${origin}/summary?success=true`,
      cancel_url: `${origin}/summary?cancelled=true`,
    });
